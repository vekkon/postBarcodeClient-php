...
class SingleBarcodeApi
{
    ...
    /**
     * Operation generateSingleBarcodes
     *
    ...
    {
        list($response) = $this->generateSingleBarcodesWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation generateSingleBarcodesWithHttpInfo
     *
     * Generate Single Barcode
     *
    ...
    /**
     * Operation generateSingleBarcodesAsync
     *
     * Generate Single Barcode
     *
     * @param  \Vekkon\PostBarcodeClient\Model\GenerateSingleBarcodes $body (optional)
     ...
     */
    public function generateSingleBarcodesAsync($body = null)
    {
        return $this->generateSingleBarcodesAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation generateSingleBarcodesAsyncWithHttpInfo
     *
     * Generate Single Barcode
     *
     * @param  \Vekkon\PostBarcodeClient\Model\GenerateSingleBarcodes $body (optional)
     ...
     */
    protected function generateSingleBarcodesRequest($body = null)
    {

        $resourcePath = '/generateSingleBarcodes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
