...
class BarcodeApi
{
    ...
    /**
     * Operation generateAddressLabel
     *
     * Generate Label
     *
    ...
    {
        list($response) = $this->generateAddressLabelWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation generateAddressLabelWithHttpInfo
     *
     * Generate Label
     *
    ...
    /**
     * Operation generateAddressLabelAsync
     *
     * Generate Label
     *
     * @param  \Swagger\Client\Model\GenerateLabel $body (optional)
     ...
     */
    public function generateAddressLabelAsync($body = null)
    {
        return $this->generateAddressLabelAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation generateAddressLabelAsyncWithHttpInfo
     *
     * Generate Label
     *
     * @param  \Swagger\Client\Model\GenerateLabel $body (optional)
     ...
     */
    protected function generateAddressLabelRequest($body = null)
    {

        $resourcePath = '/generateAddressLabel';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
