...
class ReplacementApi
{
    ...
    {
        list($response) = $this->submitReplacementRequestWithHttpInfo($body);
        return $response;
    }
    ...
    /**
     * Operation submitReplacementRequestAsync
     *
     * 
     *
     * @param  \Swagger\Client\Model\ReplacementRequest $body Replacement Request data (optional)
     ...
     */
    public function submitReplacementRequestAsync($body = null)
    {
        return $this->submitReplacementRequestAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation submitReplacementRequestAsyncWithHttpInfo
     *
     * 
     *
     * @param  \Swagger\Client\Model\ReplacementRequest $body Replacement Request data (optional)
     ...
     */
    protected function submitReplacementRequestRequest($body = null)
    {

        $resourcePath = '/generateReplacementLabel';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
